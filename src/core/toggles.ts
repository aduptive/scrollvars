...
// Keyed by the event object, so nothing outlives a dispatch: no registry of
// live scopes to keep in step with stop(), no instance whose destruction
// leaves a stale entry that silently disowns a trigger, and nothing to leak.
