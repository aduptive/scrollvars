...
**Title:** Show HN: Scrollvars – scroll animation via CSS variables, 6.7 KB, benchmarked against GSAP
...
is not "faster frames": it's the same 60fps for ~7× less bundle, a
...
via CSS variables. 6.7 KB, zero deps, and the browser does the animating.
...
Subject: ScrollVars: scroll animation via CSS variables (6.7 KB, honestly benchmarked)
...
6.7 KB gzip vs ~46 KB for the incumbents, Next.js RSC-first, and the page
...
Title: I benchmarked my 6.7 KB scroll-animation lib against GSAP and
