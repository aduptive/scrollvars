...
import 'scrollvars/styles/core.css'               // entrances, stagger, drift, spread, native view()-tier (2.5 KB gz)
// also styles/pin.css (3.2), slider.css (1.3), tilt.css (0.6), state.css (2.3, scroll-driven acts need core too), ui.css (0.7), per page needs
```
